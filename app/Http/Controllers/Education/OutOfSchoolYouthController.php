...
class OutOfSchoolYouthController extends Controller
{
    public function index(){   
        ...
        return Inertia::render('Education/OutOfSchoolYouth/Index',[
        ...
        ->whereRaw( 'timestampdiff(year, birthdate, curdate()) between ? and ?', [5,30] )->whereHas('household.educations',function($q){
                            $q->where('attendingschool', false)
                            ->where('outschoolyouth', true);
                        })
            ->first()->age,
            'pensions' => $pensions,
