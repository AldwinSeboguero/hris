...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    ...
    search: lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(function (val) {
      ...
      var _this$options = this.options,
        ...
        itemsPerPage = _this$options.itemsPerPage;
      var pageNumber = page;
      axios.get("/employees/show?page=" + pageNumber, {
        params: {
          'per_page': itemsPerPage,
          'search': this.clean(this.search),
    ...
    empDivision: lodash_debounce__WEBPACK_IMPORTED_MODULE_1___default()(function (val) {
      var _this3 = this;
      var _this$options3 = this.options,
        page = _this$options3.page,
        itemsPerPage = _this$options3.itemsPerPage;
  ...
  created: function created() {
    ...
    axios.get('/divisions').then(function (response) {
      _this4.divisions = response.data.divisions;
    });
  },
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this5.$emit('dateUpdated', _this5.dtrDate);
              case 2:
              case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return _this6.$emit('searchUpdated', _this6.search);
              case 2:
              case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _this7.$emit('emptypeUpdated', _this7.emptype);
              case 2:
              case "end":
    ...
    emitEmpDivision: function emitEmpDivision() {
      var _this8 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return _this8.$emit('empDivisionUpdated', _this8.empDivision);
              case 2:
              case "end":
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                count = 0;
                _context5.next = 6;
                return axios.get('/employees/generate', {
                  responseType: 'blob',
                  timeout: 0,
                  params: {
                    data: $val,
                    dtrDate: _this9.dtrDate
                  }
                }).then(function (response) {
    ...
    nextPage: function nextPage() {
      ...
      axios.get("/employees/show?page=" + pageNumber, {
        ...
        console.log(pageNumber);
        _this10.barangays = response.data.barangays;
        _this10.sitios = response.data.sitios;
        _this10.filtersBarangay = response.data.filtersBarangay;
        _this10.filtersSitio = response.data.filtersSitio;
        _this10.constituents = response.data.employees.data;
        _this10.current_page = response.data.employees.current_page;
        _this10.total_pages = response.data.employees.total_pages;
        _this10.total = response.data.employees.total;
      });
    }
  },
  data: function data() {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    handleEmpDivisionUpdated: function handleEmpDivisionUpdated(empDivision) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 15:
                ...
                label = _this2.emptypeParent && _this2.empdivisionParent ? _this2.emptypeParent + '_' + _this2.empdivisionParent : _this2.emptypeParent ? _this2.emptypeParent : _this2.empdivisionParent;
...
var render = function render() {
  ...
  return _c("div", [_c("div", {
  ...
  }, [_vm._v("Permanent")])])]), _vm._v(" "), _c("label", [_vm._v("Division: \n    "), _c("select", {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: _vm.empDivision,
      expression: "empDivision"
    }],
    ...
    on: {
      change: [function ($event) {
        ...
        _vm.empDivision = $event.target.multiple ? $$selectedVal : $$selectedVal[0];
      }, _vm.emitEmpDivision]
    }
...
var render = function render() {
  ...
  return _c("v-container", {
    ...
    staticClass: "page-title font-semibold font-sans row pb-2"
  }, [_c("span", {
    ...
    on: {
      ...
      empDivisionUpdated: _vm.handleEmpDivisionUpdated
    }
