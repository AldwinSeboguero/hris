<template>
    ...
    >
      ...
      <template v-slot:prepend>
        <v-list-item dark class="elevation-2" style="max-height: 50px; background: linear-gradient(to right, #33691E, #33691E, #558B2F);">
          ...
          <v-list-item-content>
            <v-list-item-title class="title text-wrap font-weight-bold" >e-SITIO</v-list-item-title>
                ...
                >
                  ...
                  <template v-for="(child, i) in item.children">
                    <v-list-item
                      ...
                      :class="
                        isUrl(child.link)
                          ? 'v-list-item--active v-list-item v-list-item--link theme--dark blue--text text--accent-4 '
                          : ''
                      "
                    >
                      <!-- <v-list-item-action
  ...
  <template v-slot:append>
    ...
    <v-app-bar
      ...
      flat
      style="background: linear-gradient(to left, #0D47A1, #0D47A1, #1E88E5);"
    >
      ...
      >
        <v-list-item class="mb-1">
          <v-list-item-avatar class="text-center ml-1" size="30">
            ...
            <v-img
              src="https://ucarecdn.com/cb531a05-6b52-44be-b6ec-a89b156bc9cb/lgu_goa_logo_80.png"
            />
          </v-list-item-avatar>

          <v-list-item-content>
            <v-list-item-title class="caption text-wrap  white--text font-weight-medium"
              >LGU GOA - PWDs</v-list-item-title
            >
            ...
            <span v-else class="inline-flex rounded-md">
              ...
              >
                You are currently using guest access (
                  <form @submit.prevent="logout">
                    <button class="underline text-sm text-blue-600 hover:text-gray-900"> Login </button>
                  </form>
                )
              </span>
            </span>
    ...
    return {
      ...
      navigationList: [
          ...
          children: [
            {
              icon: "mdi-finance",
              text: "Registered",
              link: "senior_citizens.registered",
            },
            {
              icon: "mdi-list-status",
              text: "Not Registered",
              link: "senior_citizens.not_registered",
            },
          ],
        },
        {
          ...
          text: "Pensioners",
          link: "senior_citizens.pensioners",
          withAccess: true,
        //   withAccess: (this.$page.props.auth.user.roles[0]=='Admin' || this.$page.props.auth.user.roles[0]=='Guest') ? true :false,
        },
        
        {
          ...
          text: "Constituents(Aged 59 and Above)",
          link: "constituent_aged_59",
          withAccess: true,
        //   withAccess: (this.$page.props.auth.user.roles[0]=='Admin' || this.$page.props.auth.user.roles[0]=='Guest') ? true :false,
        },
        {
