...
class NutritionallyChallengedController extends Controller
{
    public function index(){   
        ...
        return Inertia::render('Health/NutritionallyChallenged/Index',[
            ...
            ->withCount('malnourished')->having('malnourished_count','>',0)
            ->paginate()->total(),
